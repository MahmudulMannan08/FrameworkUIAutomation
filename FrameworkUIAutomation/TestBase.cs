...
namespace FrameworkUIAutomation
{
    ...
    {
        public static string HostUrl = "http://itm-dev.dev.itmagnet.biz/blank";
        ...
        public void RecordLog()
        {
            ...
            if (!ScenarioContext.Current.ContainsKey("report"))
            {
                ...
                //var path = "C:\\Users\\mahmud.DHAKA\\Documents\\Visual Studio 2015\\Projects\\FrameworkUIAutomation\\TestResults";

                //var fileName = path + "\\" + FeatureContext.Current.FeatureInfo.Title + "-" + ScenarioContext.Current.ScenarioInfo.Title + "_" + listenerId + "_.txt";
                var fileName = FeatureContext.Current.FeatureInfo.Title + "-" + ScenarioContext.Current.ScenarioInfo.Title + "_" + listenerId + "_.txt";
